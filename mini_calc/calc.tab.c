...
static const char *const yytname[] =
{
  ...
  "'/'", "'*'", "'('", "')'", "$accept", "expression", "calcul", YY_NULLPTR
};
...
{
       5,     8,     9,    10,    12,    13,    14,    15,     6,     7,
       8,     9,     1,    11,     0,     0,     0,     2,     6,     7,
       8,     9
};
